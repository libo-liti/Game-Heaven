...
public class War_ObjectPoolManager : MonoBehaviour
{
    [Serializable]
    ...
    public static War_ObjectPoolManager instance;
    ...
    private void Init()
    {
        ...
        for (int idx = 0; idx < objectInfos.Length; idx++)
        {
            ...
            for (int i = 0; i < objectInfos[idx].count; i++)
            {
                ...
                War_PoolAble poolAbleGo = CreatePooledItem().GetComponent<War_PoolAble>();
    ...
    private GameObject CreatePooledItem()
    {
        ...
        poolGo.GetComponent<War_PoolAble>().Pool = ojbectPoolDic[objectName];
        return poolGo;
    }
